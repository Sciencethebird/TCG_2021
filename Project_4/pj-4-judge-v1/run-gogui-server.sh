...
# command to launch
player='./nogo --shell --name="Hollow" --black="search=MCTS total_time=280000 worker=16 exploration=0.3" --white="search=MCTS total_time=280000 worker=16 exploration=0.3"'
# port for binding
port=${1:-auto}
